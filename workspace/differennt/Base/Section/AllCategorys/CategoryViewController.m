...
- (void)loadData {
    ...
    [headImage sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@",_dataInfo[@"Cover"]] ] placeholderImage:[UIImage imageNamed:@""]];
    headImage.alpha       = 0;
...
{
    return CGSizeMake(_CellWidth, 1.65 * _CellWidth);
}
